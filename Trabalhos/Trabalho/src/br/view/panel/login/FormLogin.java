...
/**/
        ...
        int width = 600;
        int height = 600;
        lbl_backgroung.setIcon(new ImageIcon(new ImageIcon(getClass().getResource(Imagens.LOGIN_BACKGROUND)).getImage().getScaledInstance(width, height, Image.SCALE_DEFAULT)));

        width = 30;
        height = 30;
        lbl_close.setIcon(new ImageIcon(new ImageIcon(getClass().getResource(Imagens.ICON_CLOSE)).getImage().getScaledInstance(width, height, Image.SCALE_DEFAULT)));
    ...
    private void lbl_btnResetPassMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_btnResetPassMouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Mano como vc é otário kkkk esqueceu a senha pqp");
