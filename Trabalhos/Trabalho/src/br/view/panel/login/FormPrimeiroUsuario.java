...
public class FormPrimeiroUsuario extends javax.swing.JFrame {
    ...
    public FormPrimeiroUsuario() {
        ...
        int width = 64;
        int height = 64;
        lbl_iconUsuario.setIcon(new ImageIcon(new ImageIcon(getClass().getResource(Imagens.ICON_USUARIO)).getImage().getScaledInstance(width, height, Image.SCALE_DEFAULT)));
