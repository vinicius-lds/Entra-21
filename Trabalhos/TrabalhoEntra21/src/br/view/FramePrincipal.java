...
public class FramePrincipal extends javax.swing.JFrame {
     ...
     */
    public FramePrincipal(Login sessao) {
        initComponents();
        this.controller = new ControllerPrincipal();
        this.controller.setView(this);
        this.controller.setSessao(sessao);
        //this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        this.setMinimumSize(new Dimension(this.getWidth(), this.getHeight() + 80));
        this.jPanel2.add(new PanelPrincipal());
        this.jPanel2.repaint();
        this.jPanel2.revalidate();
        this.controller.prepararBotoes(Imagem.ICON_PRINCIPAL, this.btn_principal);
        this.controller.prepararBotoes(Imagem.ICON_USUARIO, this.btn_funcionario);
        this.controller.prepararBotoes(Imagem.ICON_VENDAS, this.btn_vendas);
        this.controller.prepararBotoes(Imagem.ICON_FINANCEIRO, this.btn_financeiro);
        this.controller.prepararBotoes(Imagem.ICON_DATABASE, this.btn_crud);
        this.controller.prepararBotoes(Imagem.ICON_HISTORICO, this.btn_historico);
    }
